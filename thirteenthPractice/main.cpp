...
//Реализована основная функция работы программы по алгоритму:
//
//1. Ввод коэффициентов для 8 типов уравнений.
//2. Вывод каждого уравнения, его корней, если они есть и его корней методом подбора.