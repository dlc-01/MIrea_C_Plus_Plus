...
//Реализованы методы для нахождения одного из корней уравнений методом подбора для тех типов, где это возможно (если решения существуют в пределах от -20 до 20 с шагом в 0,01)